...
{
    public class AssesmentJSONController : ApiController
    {
        public HttpResponseMessage Get(string brfcode, int UID, int OID, int ACID, int BriefTileID = 0)
        {
            AssesmentJSONResponce assesmentJSONResponce = new AssesmentJSONResponce();
            try
            {
                ...
                assesmentJSONResponce.right = right;
                assesmentJSONResponce.wrong = wrong;
                assesmentJSONResponce.briefDatals = briefData;
                assesmentJSONResponce.scoreres = scoreres;
            ...
            return Request.CreateResponse(HttpStatusCode.OK, assesmentJSONResponce) ;
